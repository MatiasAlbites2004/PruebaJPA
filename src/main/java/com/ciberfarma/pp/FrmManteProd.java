...
public class FrmManteProd extends JFrame {
	...
	void llenaCombo() {
		...
		List<Proveedor> lstProveedores = em.createQuery("select r from Proveedor r") .getResultList();
		cboProveedores.addItem("Seleccione");
		for(Proveedor r : lstProveedores) {
			cboProveedores.addItem(r.getIdproveedor());
	...
	void listado() {
		...
		for(Producto p :lstProductos) {
			txtSalida.append(p.getId_prod() + " " + p.getDes_prod() + " " + p.getStk_prod()
